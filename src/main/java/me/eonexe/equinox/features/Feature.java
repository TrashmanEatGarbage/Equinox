...
import me.eonexe.equinox.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = Equinox.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof EquinoxGui) {
            EquinoxGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
