...
import me.eonexe.equinox.event.events.RenderEntityModelEvent;
...
class CrystalModifier
    ...
    void onRenderModel ( RenderEntityModelEvent event ) {
        ...
        Color color = this.colorSync.getValue ( ) ? ClickGui.getInstance().getCurrentColor ( ) : EntityUtil.getColor ( event.entity , this.red.getValue ( ) , this.green.getValue ( ) , this.blue.getValue ( ) , this.alpha.getValue ( ) , false );
