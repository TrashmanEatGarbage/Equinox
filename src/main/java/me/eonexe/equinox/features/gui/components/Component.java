package me.eonexe.equinox.features.gui.components;
...
import me.eonexe.equinox.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Equinox.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) EquinoxGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            EquinoxGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
