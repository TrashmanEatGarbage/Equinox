...
class Speedmine
    ...
    void onTick ( ) {
        if ( this.currentPos != null ) {
            ...
            if ( Speedmine.mc.player != null && this.silentSwitch.getValue ( ) && this.timer.passedMs ( (int) ( 2000.0f * Equinox.serverManager.getTpsFactor ( ) ) ) && this.getPickSlot ( ) != - 1 ) {
    ...
    void onRender3D ( Render3DEvent event ) {
        if ( this.render.getValue ( ) && this.currentPos != null ) {
            Color color = new Color ( this.timer.passedMs ( (int) ( 2000.0f * Equinox.serverManager.getTpsFactor ( ) ) ) ? 0 : 255 , this.timer.passedMs ( (int) ( 2000.0f * Equinox.serverManager.getTpsFactor ( ) ) ) ? 255 : 0 , 0 , 255 );
