...
import me.eonexe.equinox.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Equinox.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Equinox.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Equinox.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Equinox.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
