...
import me.eonexe.equinox.util.EntityUtil2;
...
class LongJump
    ...
    public
    void onDisable ( ) {
        Equinox.timerManager.setTimer ( 1.0f );
    }
    ...
    void doNormal ( final UpdateWalkingPlayerEvent event ) {
        ...
        switch (this.mode.getValue ( )) {
            ...
            case DIRECT: {
                if ( EntityUtil2.isInLiquid ( ) || EntityUtil2.isOnLiquid ( ) ) {
                    break;
                }
                ...
                if ( ! LongJump.mc.player.collidedVertically ) {
                    ...
                    Equinox.timerManager.setTimer ( 0.85f );
    ...
    void doVirtue ( final MoveEvent event ) {
        if ( this.mode.getValue ( ) == Mode.VIRTUE && ( LongJump.mc.player.moveForward != 0.0f || ( LongJump.mc.player.moveStrafing != 0.0f && ! EntityUtil2.isOnLiquid ( ) && ! EntityUtil2.isInLiquid ( ) ) ) ) {
            if ( this.stage == 0 ) {
