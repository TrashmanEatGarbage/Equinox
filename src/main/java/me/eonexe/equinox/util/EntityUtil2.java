...
import me.eonexe.equinox.features.modules.player.Blink;
import me.eonexe.equinox.features.modules.misc.NewFakePlayer;
import me.eonexe.equinox.features.modules.player.Freecam;
import me.eonexe.equinox.mixin.mixins.accessors.IEntityLivingBase;
...
class EntityUtil2 implements Util {
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals(EntityUtil.mc.player) || (entity instanceof EntityPlayer && Equinox.friendManager.isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
