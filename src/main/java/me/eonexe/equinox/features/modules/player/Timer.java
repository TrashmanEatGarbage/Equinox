...
class Timer
        extends Module {
    private final me.eonexe.equinox.util.Timer timer = new me.eonexe.equinox.util.Timer ( );
        private final me.eonexe.equinox.util.Timer turnOffTimer = new me.eonexe.equinox.util.Timer ( );
