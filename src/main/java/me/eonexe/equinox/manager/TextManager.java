...
import me.eonexe.equinox.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = Equinox.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (Equinox.moduleManager.isModuleEnabled(FontMod.class)) {
            if (shadow) {
